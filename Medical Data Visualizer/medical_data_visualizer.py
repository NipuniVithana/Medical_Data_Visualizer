...
def draw_cat_plot():
    ...
    # Group and reformat the data to split it by 'cardio'.Show the counts of each feature.Then rename one of the columns for the catplot to work correctly
    df_cat["total"]=1
...
def draw_heat_map():
    ...
    # Gennerate a mask for the upper traingle
    mask = np.triu(corr)
